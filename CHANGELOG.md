...
- `@driftless-ai/core` — Core types, utilities, framework adapters, workflow templates, and skill templates
- `@driftless-ai/cli` — CLI entry point with interactive wizard, installed as `driftless` binary
