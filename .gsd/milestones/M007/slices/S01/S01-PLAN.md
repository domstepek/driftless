...
- [ ] **T01: Extract Nav and Footer into shared components** `est:20m`
...
- [ ] **T02: Build the /pricing page with tier cards** `est:25m`
...
- [ ] **T03: Wire nav/footer links and run full verification** `est:15m`
